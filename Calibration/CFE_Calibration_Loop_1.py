...
for i in range(0,52): 
    ...
    all_result_filename = str(g) + '_all_results_dds_' + scheme + '_'  + str(N) + '.npy'
    ...
    best_run_filename = str(g) + '_best_run_' + scheme + '_'  + str(N) + '.json'
    ...
    param_trace_imgname = str(g) + '_param_trace_' + scheme + '_' + str(N) + '.png'
    param_trace_dir = os.path.join(png_dir,"ParamTrace")
    if os.path.exists(param_trace_dir)==False: os.mkdir(param_trace_dir)
    ...
    objvalues_imgname = str(g) + "_obj_values_" + scheme + '_'  + str(N) + ".png"
    objvalues_dir = os.path.join(png_dir,"Obj_Trace")
    if os.path.exists(objvalues_dir)==False: os.mkdir(objvalues_dir)
    ...
    comparison_imgname = str(g) + "_comparison_" + scheme + '_' +str(N) + ".png"
